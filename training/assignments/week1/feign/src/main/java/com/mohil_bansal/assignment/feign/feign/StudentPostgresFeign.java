...
@FeignClient(value = "student-postgres", url = "http://localhost:8082/students")
public interface StudentPostgresFeign {
    ...
    CommonResponse<ResponseStudentDto> addStudent(@RequestBody RequestStudentDto requestStudentDto, @PathVariable Long orgId);
}