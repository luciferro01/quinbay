...
public class RegistrationController {
    ...
    public ResponseEntity<CommonResponse<RegistrationDto>> registerStudentToCourse(@RequestBody RegistrationDto registrationDto) {
        ...
        RegistrationDto registration = registrationService.registerStudentToCourse(registrationDto);
        CommonResponse<RegistrationDto> response = CommonResponse.success(registration, 200, "Registration successful");
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<CommonResponse<RegistrationDto>> updateCourseStatus(@RequestBody RegistrationDto registrationDto) {
        ...
        RegistrationDto updatedRegistration = registrationService.updateCourseStatus(registrationDto);
        CommonResponse<RegistrationDto> response = CommonResponse.success(updatedRegistration, 200, "Registration updated successfully");
        return ResponseEntity.ok(response);
    }
}